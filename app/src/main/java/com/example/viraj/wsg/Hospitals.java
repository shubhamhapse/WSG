...
public class Hospitals extends ExtendForEveryActivityWithDrawer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text1.setText("Dr. Deshpande Clinic");
