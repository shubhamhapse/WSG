...
public class ATM extends ExtendForEveryActivityWithDrawer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text6.setText(R.string.atm_idbi_bank_address);

        TextView text7 = (TextView)(findViewById(R.id.content_2_2));
        text7.setText(R.string.atm_icici_bank_address);

        TextView text8 = (TextView)(findViewById(R.id.content_2_3));
        text8.setText(R.string.atm_bank_of_india_address);

        TextView text9 = (TextView)(findViewById(R.id.content_2_4));
        text9.setText(R.string.atm_state_bank_of_india_address);

        TextView text10 = (TextView)(findViewById(R.id.content_2_5));
        text10.setText(R.string.atm_axis_bank_address);
